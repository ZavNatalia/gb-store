...
export default class ProductService {
    static async getPaginatedProducts(offset: number, limit: number, config: any, sortOrder: string, sortType: string = 'price'): Promise<AxiosResponse<IProduct[]>> {
    ...
    static async getAllProductsByCategory(name: string, offset: number, limit: number, config: any, sortOrder: string, sortType: string = 'price'): Promise<AxiosResponse> {
        return axios.get(`${rootURL}/items/?param=${name}&sortType=${sortType}&sortOrder=${sortOrder}&offset=${offset}&limit=${limit}`, config)
    }
    static async getProductsBySearchQuery(searchQuery: string = '', offset: number, limit: number, config: any, sortOrder: string, sortType: string = 'price'): Promise<AxiosResponse> {
